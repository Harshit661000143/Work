public class WorkWithAnimals{
	    ...
	    public static void main(String[] args){
	        ...
	        ((Dog )fido).setSpeed(10);
	        double speed=fido.getSpeed();
	        double height=fido.getheight();
	        ...
	        System.out.println("Kitty says: " +animals[1].getSound() + "\n");
	         animals[0].setSpeed(10);
	         animals[0].setheight(500);
	         speed=animals[0].getSpeed();
	         height=animals[0].getheight();
         
	        System.out.println("Main Speed now" + speed);
	        System.out.println("Main Height now" + height);
